...
class Madara extends DOMMangaScraper {
    ...
    queries: DOMMangaScraperQueries = {
        ...
        images: {
            image: 'div > img[id*=image-], figure > img[class*=image-], li figure img',
        ...
        search: {
            ...
            updated: 'div.meta-item.post-on span.font-meta:not(:has(a)), div.meta-item.post-on span.font-meta a',
            updated_attr: 'title',
            encode: true,
        },
        date_formats: ['MMMM DD, YYYY', 'DD MMM hh:mm', 'DD/MM/YYYY'],
    };
